...
def step_5(road:Road):
    ...
    #print(f"Road {road.road_id} {road.position_vehicles}- Previous Road Max Global T: {road.previous_road_max_global_t},  Max Global T: {road.max_global_t}")
...
def step_6(road:Road):
    ...
    #print(f"Road {road.road_id} t {road.global_t} {road.position_vehicles}- Previous Road Max Global T: {road.previous_road_max_global_t},  Max Global T: {road.max_global_t}")
